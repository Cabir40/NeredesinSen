package com.projem.neredesinsenv4;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        // diğer menuler için intent ekleyebiliriz
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location location) {
                ...
                if(sw_konum.isChecked()){
                    ...
                    // mode_private kısmını değiştirmemiz gerekebilir.
                    /*
                    try {
                        database = MainActivity.this.openOrCreateDatabase("Locations",MODE_PRIVATE,null);
                        database.execSQL("CREATE TABLE IF NOT EXISTS tLocation (id INTEGER PRIMARY KEY, mail VARCHAR, latitude DOUBLE, longitude DOUBLE)");
                        String toCompile ="INSERT INTO tLocation(mail,latitude,longitude) VALUES (?,?,?)";
                        SQLiteStatement sqLiteStatement = database.compileStatement(toCompile);
                        sqLiteStatement.bindString(1,konumum.mail);
                        sqLiteStatement.bindDouble(2,konumum.latitude);
                        sqLiteStatement.bindDouble(3,konumum.longitude);
    ...
    public void konumagit(View View) {
        Intent intent_me = new Intent(MainActivity.this, com.projem.neredesinsenv4.MapsActivity.class);
